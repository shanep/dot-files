...
BEGIN {
    ...
    author = ENVIRON["AUTHOR"] != "" ? ENVIRON["AUTHOR"] : "Shane K. Panter"

    # and to your email address
    emailaddress = ENVIRON["EMAIL"] != "" ? ENVIRON["EMAIL"] : "shanepanter@boisestate.edu"
    ...
    filetags = ENVIRON["FILETAGS"] != "office" ? ENVIRON["FILETAGS"] : "meeting"
